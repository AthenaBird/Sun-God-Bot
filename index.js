...
var schedule = schedule.scheduleJob('0 * * * * *', function(){
  ...
  console.log(datetime + ' Checking for events every 30 minutes...');
...
client.on("message", message => {
  ...
  // TEMPORARY: Check Calendar since HTTP req doesnt work
  //setTimeout(s => {client.commands.get("checkCalendar").execute(client, sql_calendar)}, 10000); 
  //client.commands.get("checkcalendar").execute(client, sql_calendar);
